...
class OutsidersBusinessRView: OutsidersMonitorRView {
    override func setupUI() {
        super.setupUI()
        titleL.text = "进入营业室外来人员登记"
        subTitleL.text = "人员信息登记"
        val5TV.placeholder = "事由"
    }
}

class OutsidersMonitorRView: ElecCreateScrollView {
    ...
    override func setupUI() {
        ...
        val6TF.placeholder = "进入时间"
        val6TF.value = Date.nowCN()
        addSubview(val6TF)
